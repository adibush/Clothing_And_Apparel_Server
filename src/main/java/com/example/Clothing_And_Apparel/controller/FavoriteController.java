...
public class FavoriteController {
    ...
    @CrossOrigin
    public void postFavorite(@RequestBody Favorite favorite,@RequestParam(value = "Authorization") String token) {
        String jwt = token.substring(7);
        String userName = jwtUtil.extractUsername(jwt);
        favoriteService.postFavoriteItem(favorite,userName);
    }
